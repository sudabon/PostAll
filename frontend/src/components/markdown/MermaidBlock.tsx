...
export function MermaidBlock({ source }: { source: string }) {
  ...
  return (
    <div ref={host} className="my-2 rounded-md border border-border p-2" data-testid="mermaid-block">
      <div className="mb-1 flex justify-end">
        <button type="button" className="text-xs text-muted-foreground" onClick={() => setMode((m) => (m === 'diagram' ? 'source' : 'diagram'))}>
